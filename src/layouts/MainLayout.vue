  ...
  <a-layout style="min-height: 100vh">
    <a-layout-header class="header">
      <a-row align="middle" class="header-row">
        <a-col :span="4">
          <div class="logo-area">
            <img src="@/assets/sola.png" alt="logo" class="logo-img" />
            <span class="logo-title">OJ Platform</span>
          </div>
        </a-col>
        <a-col :span="16" :offset="1">
          <a-menu mode="horizontal" :selected-keys="[selectedKey]" @click="onMenuClick" class="main-menu">
        ...
        <a-col :span="3">
          <a-row justify="end" class="user-area">
    ...
    <a-divider style="
        ...
        width: 50%;
        border-top: 2px solid #e5e6eb !important;
        border-radius: 2px;
        min-width: 200px;
        max-width: 600px;
      " />
